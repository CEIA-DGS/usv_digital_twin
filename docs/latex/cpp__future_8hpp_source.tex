...
\hypertarget{cpp__future_8hpp_source}{}\label{cpp__future_8hpp_source}\index{build/dt\_core/\_deps/nlohmann\_json-\/src/include/nlohmann/detail/meta/cpp\_future.hpp@{build/dt\_core/\_deps/nlohmann\_json-\/src/include/nlohmann/detail/meta/cpp\_future.hpp}}
...
\DoxyCodeLine{00024\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacedetail_ad76afb2c3a23eb88e7efb7c5d5499574}{uncvref\_t}}\ =\ \textcolor{keyword}{typename}\ std::remove\_cv<typename\ std::remove\_reference<T>::type>::type;}
\DoxyCodeLine{00025\ }
...
\DoxyCodeLine{00038\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacedetail_a66bbcd629c83a87ba9cbc72a675cf84a}{enable\_if\_t}}\ =\ \textcolor{keyword}{typename}\ std::enable\_if<B,\ T>::type;}
\DoxyCodeLine{00039\ }
...
\DoxyCodeLine{00066\ \{}
\DoxyCodeLine{00067\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{structdetail_1_1integer__sequence_a37ef697ff49523bc0fe5e83afabd8a09}{value\_type}}\ =\ T;}
\DoxyCodeLine{00068\ \ \ \ \ \textcolor{keyword}{static}\ \textcolor{keyword}{constexpr}\ \mbox{\hyperlink{namespacestd_aa30247b5e1a6e192c486364692e37832}{std::size\_t}}\ \mbox{\hyperlink{structdetail_1_1integer__sequence_ae4d9136f834057a4b68a115554eb9817}{size}}()\ noexcept}
\DoxyCodeLine{00069\ \ \ \ \ \{}
...
\DoxyCodeLine{00080\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structdetail_1_1integer__sequence}{index\_sequence}}\ =\ \mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<size\_t,\ Ints...>;}
\DoxyCodeLine{00081\ }
...
\DoxyCodeLine{00086\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structdetail_1_1utility__internal_1_1Extend}{Extend}};}
\DoxyCodeLine{00087\ }
...
\DoxyCodeLine{00090\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structdetail_1_1utility__internal_1_1Extend}{Extend}}<\mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<T,\ Ints...>,\ SeqSize,\ 0>}
\DoxyCodeLine{00091\ \{}
\DoxyCodeLine{00092\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{structdetail_1_1integer__sequence}{type}}\ =\ \mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}\ <\ T,\ Ints...,\ (Ints\ +\ SeqSize)...\ >;}
\DoxyCodeLine{00093\ \};}
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00095\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ T...\ Ints,\ \textcolor{keywordtype}{size\_t}\ SeqSize>}
\DoxyCodeLine{00096\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structdetail_1_1utility__internal_1_1Extend}{Extend}}<\mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<T,\ Ints...>,\ SeqSize,\ 1>}
\DoxyCodeLine{00097\ \{}
\DoxyCodeLine{00098\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{structdetail_1_1integer__sequence}{type}}\ =\ \mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}\ <\ T,\ Ints...,\ (Ints\ +\ SeqSize)...,\ 2\ *\ SeqSize\ >;}
\DoxyCodeLine{00099\ \};}
\DoxyCodeLine{00100\ }
...
\DoxyCodeLine{00104\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structdetail_1_1utility__internal_1_1Gen}{Gen}}}
\DoxyCodeLine{00105\ \{}
\DoxyCodeLine{00106\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{structdetail_1_1utility__internal_1_1Gen_a8e6956b5d9403052dd1e9f12dd2ac326}{type}}\ =}
\DoxyCodeLine{00107\ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structdetail_1_1utility__internal_1_1Extend}{Extend}}\ <\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structdetail_1_1utility__internal_1_1Gen}{Gen}}\ <\ T,\ \mbox{\hyperlink{FuzzerTracePC_8cpp_a08b50a855be4f7cd9cbb84fd2fdb8a8e}{N}}\ /\ 2\ >\mbox{\hyperlink{structdetail_1_1utility__internal_1_1Gen_a8e6956b5d9403052dd1e9f12dd2ac326}{::type}},\ \mbox{\hyperlink{FuzzerTracePC_8cpp_a08b50a855be4f7cd9cbb84fd2fdb8a8e}{N}}\ /\ 2,\ \mbox{\hyperlink{FuzzerTracePC_8cpp_a08b50a855be4f7cd9cbb84fd2fdb8a8e}{N}}\ \%\ 2\ >\mbox{\hyperlink{structdetail_1_1utility__internal_1_1Gen_a8e6956b5d9403052dd1e9f12dd2ac326}{::type}};}
\DoxyCodeLine{00108\ \};}
\DoxyCodeLine{00109\ }
\DoxyCodeLine{00110\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00111\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structdetail_1_1utility__internal_1_1Gen}{Gen}}<T,\ 0>}
\DoxyCodeLine{00112\ \{}
\DoxyCodeLine{00113\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{structdetail_1_1integer__sequence}{type}}\ =\ \mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence<T>}};}
\DoxyCodeLine{00114\ \};}
\DoxyCodeLine{00115\ }
...
\DoxyCodeLine{00126\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacedetail_a517a072d9de78dcbc9c44c39f75a0d92}{make\_integer\_sequence}}\ =\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structdetail_1_1utility__internal_1_1Gen_a8e6956b5d9403052dd1e9f12dd2ac326}{utility\_internal::Gen<T,\ N>::type}};}
\DoxyCodeLine{00127\ }
...
\DoxyCodeLine{00134\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacedetail_a82dd889f447e7a1383b8757be27f66e9}{make\_index\_sequence}}\ =\ \mbox{\hyperlink{namespacedetail_a517a072d9de78dcbc9c44c39f75a0d92}{make\_integer\_sequence<size\_t,\ N>}};}
\DoxyCodeLine{00135\ }
...
\DoxyCodeLine{00142\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacedetail_ad2cab3320b7c6d98af3ddf06c1a6b112}{index\_sequence\_for}}\ =\ \mbox{\hyperlink{namespacedetail_a82dd889f447e7a1383b8757be27f66e9}{make\_index\_sequence}}<\textcolor{keyword}{sizeof}...(Ts)>;}
\DoxyCodeLine{00143\ }
\DoxyCodeLine{00145\ }
...
\DoxyCodeLine{00155\ \{}
\DoxyCodeLine{00156\ \ \ \ \ \textcolor{keyword}{static}\ \mbox{\hyperlink{macro__scope_8hpp_a199f48c1e50525ddb97373c6c7cfe8d7}{JSON\_INLINE\_VARIABLE}}\ \textcolor{keyword}{constexpr}\ T\ \mbox{\hyperlink{structdetail_1_1static__const_ad8a1b74474ed4d51312e0e3daa46afa5}{value}}\{\};}
\DoxyCodeLine{00157\ \};}
\DoxyCodeLine{00158\ }
...
\DoxyCodeLine{00161\ \ \ \ \ \textcolor{keyword}{constexpr}\ T\ \mbox{\hyperlink{structdetail_1_1static__const_ad8a1b74474ed4d51312e0e3daa46afa5}{static\_const<T>::value}};}
...
\DoxyCodeLine{00165\ \textcolor{keyword}{inline}\ \textcolor{keyword}{constexpr}\ std::array<T,\ \textcolor{keyword}{sizeof}...(Args)>\ \mbox{\hyperlink{namespacedetail_a346dced829a9a2b98a722a31c62b3f7a}{make\_array}}(Args\&\&\ ...\ args)}
\DoxyCodeLine{00166\ \{}
...
\DoxyCodeLine{00171\ \mbox{\hyperlink{abi__macros_8hpp_a9a4005b8c985f1d04dcc87918cab2019}{NLOHMANN\_JSON\_NAMESPACE\_END}}}
