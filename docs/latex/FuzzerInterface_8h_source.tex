...
\hypertarget{FuzzerInterface_8h_source}{}\label{FuzzerInterface_8h_source}\index{build/dt\_core/\_deps/nlohmann\_json-\/src/tests/thirdparty/Fuzzer/FuzzerInterface.h@{build/dt\_core/\_deps/nlohmann\_json-\/src/tests/thirdparty/Fuzzer/FuzzerInterface.h}}
\mbox{\hyperlink{FuzzerInterface_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00033\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{FuzzerInterface_8h_a1c473c9665269a78ef9001573a6995df}{LLVMFuzzerTestOneInput}}(\textcolor{keyword}{const}\ uint8\_t\ *\mbox{\hyperlink{structData}{Data}},\ \textcolor{keywordtype}{size\_t}\ Size);}
\DoxyCodeLine{00034\ }
...
\DoxyCodeLine{00039\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{FuzzerInterface_8h_aa30889313cc057073351a87b2590b886}{LLVMFuzzerInitialize}}(\textcolor{keywordtype}{int}\ *argc,\ \textcolor{keywordtype}{char}\ ***\mbox{\hyperlink{afl__driver_8cpp_a5d7d76db953dad5fc7ae40344df71c58}{argv}});}
\DoxyCodeLine{00040\ }
...
\DoxyCodeLine{00045\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{FuzzerInterface_8h_a3b281a5909310708b6527566346e50e7}{LLVMFuzzerCustomMutator}}(uint8\_t\ *\mbox{\hyperlink{structData}{Data}},\ \textcolor{keywordtype}{size\_t}\ Size,\ \textcolor{keywordtype}{size\_t}\ MaxSize,}
...
\DoxyCodeLine{00052\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{FuzzerInterface_8h_a64107a3e01dcb18d4a402a90c7625d30}{LLVMFuzzerCustomCrossOver}}(\textcolor{keyword}{const}\ uint8\_t\ *Data1,\ \textcolor{keywordtype}{size\_t}\ Size1,}
...
\DoxyCodeLine{00061\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{FuzzerInterface_8h_a707cf06cec36db401461e605e1515f51}{LLVMFuzzerMutate}}(uint8\_t\ *\mbox{\hyperlink{structData}{Data}},\ \textcolor{keywordtype}{size\_t}\ Size,\ \textcolor{keywordtype}{size\_t}\ MaxSize);}
\DoxyCodeLine{00062\ }
